    ...
    <div class="card mx-auto mt-5" style="width: 40rem; box-shadow: 15px 15px 30px -10px grey;">
        <div class="card-body">
            ...
            <form class="form-horizontal" method="POST">
                ...
                <input class="btn btn-primary" type="submit" name="simpan" value="Simpan"></input>
...
if (isset($_POST['simpan'])) {
    ...
    include("koneksi.php");
    $sql = "INSERT INTO mahasiswa (`nim`,`nama`,`jenis_kelamin`,`jurusan`,`alamat`) VALUES('$nim','$nama','$jk','$jurusan','$alamat')";
...
?>
    ...
    ?>
        <script>
            alert("Mahasiswa Gagagl ditambahkan");
        </script>
<?php
    }
}
